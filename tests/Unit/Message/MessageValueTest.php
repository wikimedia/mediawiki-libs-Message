...
class MessageValueTest extends TestCase {
	...
	public function testTextParamsOfType() {
		...
		$this->assertSame(
			'<message key="key">' . '<bitrate>1</bitrate><bitrate>2</bitrate>' . '</message>',
			$mv->dump()
		);
		$this->assertSame( $mv, $mv2 );
	}
	...
	public function testNumParams() {
		...
		$this->assertSame(
			'<message key="key">' . '<num>1</num>' . '<num>2</num>' . '</message>',
			$mv->dump()
		);
		$this->assertSame( $mv, $mv2 );
	}
	...
	public function testLongDurationParams() {
		...
		$this->assertSame(
			'<message key="key">' . '<duration>1</duration>' . '<duration>2</duration>' . '</message>',
			$mv->dump()
		);
		$this->assertSame( $mv, $mv2 );
	}
	...
	public function testShortDurationParams() {
		...
		$this->assertSame(
			'<message key="key">' . '<period>1</period>' . '<period>2</period>' . '</message>',
			$mv->dump()
		);
		$this->assertSame( $mv, $mv2 );
	}
	...
	public function testExpiryParams() {
		...
		$this->assertSame(
			'<message key="key">' . '<expiry>1</expiry>' . '<expiry>2</expiry>' . '</message>',
			$mv->dump()
		);
		$this->assertSame( $mv, $mv2 );
	}
	...
	public function testDateTimeParams() {
		...
		$this->assertSame(
			'<message key="key">' . "<datetime>$ts</datetime>" . '</message>',
			$mv->dump()
		);
		$this->assertSame( $mv, $mv2 );
	}
	...
	public function testDateParams() {
		...
		$this->assertSame(
			'<message key="key">' . "<date>$ts</date>" . '</message>',
			$mv->dump()
		);
		$this->assertSame( $mv, $mv2 );
	}
	...
	public function testTimeParams() {
		...
		$this->assertSame(
			'<message key="key">' . "<time>$ts</time>" . '</message>',
			$mv->dump()
		);
		$this->assertSame( $mv, $mv2 );
	}
	...
	public function testUserGroupParams() {
		...
		$this->assertSame(
			'<message key="key">' . "<group>bot</group>" . '</message>',
			$mv->dump()
		);
		$this->assertSame( $mv, $mv2 );
	}
	...
	public function testSizeParams() {
		...
		$this->assertSame(
			'<message key="key">' . '<size>1</size>' . '<size>2</size>' . '</message>',
			$mv->dump()
		);
		$this->assertSame( $mv, $mv2 );
	}
	...
	public function testRawParams() {
		...
		$this->assertSame(
			'<message key="key">' . '<raw>1</raw>' . '<raw>2</raw>' . '</message>',
			$mv->dump()
		);
		$this->assertSame( $mv, $mv2 );
	}
	...
	public function testPlaintextParams() {
		...
		$this->assertSame(
			'<message key="key">' . '<plaintext>1</plaintext>' . '<plaintext>2</plaintext>' . '</message>',
			$mv->dump()
		);
		$this->assertSame( $mv, $mv2 );
	}
	...
	public function testCommaListParams() {
		...
		$this->assertSame(
			'<message key="key">' . '<list listType="comma">' . '<text>a</text><text>b</text>' . '</list></message>',
			$mv->dump()
		);
		$this->assertSame( $mv, $mv2 );
	}
	...
	public function testPipeListParams() {
		...
		$this->assertSame(
			'<message key="key">' . '<list listType="pipe">' . '<text>a</text><text>b</text>' . '</list></message>',
			$mv->dump()
		);
		$this->assertSame( $mv, $mv2 );
	}
	...
	public function testTextListParams() {
		...
		$this->assertSame(
			'<message key="key">' . '<list listType="text">' . '<text>a</text><text>b</text>' . '</list></message>',
			$mv->dump()
		);
		$this->assertSame( $mv, $mv2 );
	}
